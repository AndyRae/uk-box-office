			...
			<div className='flex mt-2.5'>
				<div className='relative w-full'>
					...
					<button
						type='submit'
						aria-label='Search'
						className='absolute top-0 right-0 p-2 text-sm font-medium text-white bg-bo-primary rounded-r-lg border-1 border-bo-primary hover:bg-cyan-500 focus:ring-4 focus:outline-none focus:ring-red-300'
					>
