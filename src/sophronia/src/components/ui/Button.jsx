export const Button = ({ children, onClick, ...props }) => {
	return (
		<button
			...
			{...props}
		>
			<span className='relative px-5 py-1.5 transition-all inline-flex items-center ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0'>
				{children}
			</span>
		</button>
	);
