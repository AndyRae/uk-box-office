...
export const About = () => {
	return (
		<div className='flex flex-col max-w-xl space leading-7 space-between gap-4'>
			...
			<p>
				This is a tool ideal for film professionals, researchers, and students;
				aiming to help create a more intelligent and open sector. Before this
				website, you had to dig through those spreadsheets or rely on box office
				mojo, which is in dollars.
			</p>
			<p>
				...
				errors in the data, as there are over 10,000 films, 1,000 distributors,
				and 40,000 weekly records.
			</p>
			<p>
			...
			<p>
				...
				<InlineLink to={'/contact'}>please do get in touch with me </InlineLink>
				if you have an idea that could make the site better, or more useful for
				you.
			</p>
			<p>
